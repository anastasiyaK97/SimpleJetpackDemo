...
import me.krasnova.common.utils.getColorByString
import me.krasnova.common.utils.networkImagePainter
...
fun QuickCardLayout(card: QuickCard, cardHeightDp: Int, modifier: Modifier = Modifier) {
    Card(
        ...
        Box {
            Image(
                painter = networkImagePainter(card.quickCardData.imageUrl),
